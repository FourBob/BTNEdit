...
SRC_C := src/main.c src/render.c src/editor.c src/gapbuffer.c src/highlight.c src/strings.c src/eol.c src/textinput.c src/filestamp.c src/recovery.c src/ai.c
SRC_M := src/shim.m
