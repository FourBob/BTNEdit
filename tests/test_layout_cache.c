/* Layout-Cache und inkrementeller Kommentar-Zustand gegen einen frischen
 * Aufbau, ueber zufaellige Edit-Folgen (render.c). */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include "editor.h"
...
int main(void) {
    ...
    for (int step = 0; step < 6000; step++) {
        ...
        const BtnLangSpec *lang = rnd(8) == 0 ? NULL : c_lang;
